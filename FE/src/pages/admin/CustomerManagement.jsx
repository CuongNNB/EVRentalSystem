...
const MOCK_COMPLAINTS = [
  {
    ...
    subject: 'Xe bị hỏng giữa đường',
    content: 'Xe VF 8 bị chết máy khi đang chạy trên đường',
    status: 'processing',
    priority: 'high',
  ...
  },
  {
    ...
    subject: 'Tính phí không đúng',
    content: 'Bị tính phí vượt quá thời gian thuê thực tế',
    status: 'resolved',
    priority: 'medium',
...
const CustomerManagement = () => {
  ...
  const filteredCustomers = MOCK_CUSTOMERS.filter(customer => {
    ...
    let matchTab = true
    if (activeTab === 'vip') matchTab = customer.status === 'vip'
